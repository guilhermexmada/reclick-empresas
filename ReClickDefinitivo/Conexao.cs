...
namespace ReClickDefinitivo
{
    class Conexao
    {
        ...
        public void inicializar()
        {
            ...
            database + ";" + "UID=" + usuario + ";" + "PASSWORD=" + senha + "; Convert Zero Datetime = TRUE";
            //converterodatetime=true serve para converter tipo datetime do SQL para tipo datatime do SISTEMA
